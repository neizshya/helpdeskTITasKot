    <div class="modal fade" id="modal_e-sertifikat_detail_admin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="d-flex row justify-content-center align-items-center">
                        <div class="col-12 text-center">
                            ...
                            <p class="text-uppercase fw-semibold">Status Tanda Tangan Elektronik</p>
                        </div>
                        <div class="col-12">
