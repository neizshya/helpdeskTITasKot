    <div class="modal fade" id="modal_subdomain_detail_user" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center align-items-center">
                        <h2 class="text-uppercase">Status Pembuatan</h2>
                    </div>
                    <div class="container ">
                        <div class="row">
                            <div class="col-12">
