                            ...
                            <table class="table table  align-items-center mb-0">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Link Aplikasi</th>
                                ...
                                <tbody>
                                    <tr class="text-center">
                                        <td class="align-middle text-center text-sm">5566135615</td>
                                        ...
                                        <td class="align-middle text-center text-sm">Nama Aplikasi A</td>
                                        <td class="align-middle text-center text-sm">Link Aplikasi A</td>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-3">
                            <table class="table table  align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr class="text-center">
                                        <td class="align-middle text-center text-sm">515615415615651</td>
                                        <td class="align-middle text-center text-sm">2023-10-16</td>
                                        <td class="align-middle text-center text-sm">6445531335</td>
                                        <td class="align-middle text-center text-sm">OPD A</td>
                                        <td class="align-middle text-center text-sm">John Doe</td>
                                    ...
                                    <tr class="text-center">
                                        <td class="align-middle text-center text-sm">6846166161661</td>
                                        <td class="align-middle text-center text-sm">2023-10-16</td>
                                        <td class="align-middle text-center text-sm">6445531335</td>
                                        <td class="align-middle text-center text-sm">OPD A</td>
                                        <td class="align-middle text-center text-sm">John Doe</td>
